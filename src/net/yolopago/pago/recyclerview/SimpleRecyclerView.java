...
public class SimpleRecyclerView extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements StickHeaderItemDecoration.StickyHeaderInterface {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            case 1:
                return new SimpleRecyclerView.HeaderViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_txheader, parent, false));
            case 2:
                return new SimpleRecyclerView.Header2ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_txheader, parent, false));
            default:
                return new SimpleRecyclerView.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_tx, parent, false));
        }
    }
    ...
    class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        HeaderViewHolder(View itemView) {
            super(itemView);
            tvHeader = itemView.findViewById(R.id.statusTextView);
        }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            tvRows = itemView.findViewById(R.id.statusTextView);
        }
