...
public class BatchInfo
{
	...
	private BigInteger saleAmount  = BigInteger.valueOf(0);
    ...
    public void initBatch(int batchNumber)
    {
    	...
    	saleAmount = BigInteger.valueOf(0);
    ...
    public void loadBatch()
    {
    	...
    	saleAmount    = BigInteger.valueOf(batchPref.getInt(saleAmountTag, 0));
    ...
    public void incSale(Long amount)
    {
    	//saleCount += 1;
		//saleAmount += amount;
