...
{
	// Default EMV Param
	private final byte DEFAULT_TTQ = 0x32;
	private final String DEFAULT_COUNTRY_CODE = "0484";
	private final String DEFAULT_TERMINAL_TYPE = "22";
	private final String DEFAULT_TERMINAL_CAPABILITY = "E0B8C8";//B0B8C8ANTES  E0F0C8 //E060C8
	private final String DEFAULT_ADDITIONAL_TERMINAL_CAPABILITY = "FF80F0A001";
	...
	private final int    DEFAULT_CONTACTLESS_LIMIT = 1000000000;
	private final int    DEFAULT_CONTACTLESS_FLOOR_LIMIT = 1000000000;
    private final int    DEFAULT_CONTACTLESS_CVM_LIMIT = 1000000000;//1000
    ...
    private final String cnTag                = "cnid";
	...
	private String  mid = "8284091";
    private String initControlNumber = "201907041741VEN1REV";
	...
	private int contactlessLimit = 1000000000;
	private int contactlessFloorLimit = 1000000000;
	private int cvmLimit = 1000000000;
    ...
    public void loadTerminalConfig()
    {
    	...
    	mid = terminalPref.getString(midTag, "8284091");
    	merchantName1 = terminalPref.getString(merchantName1Tag, "test merchant");
        initControlNumber = terminalPref.getString(cnTag, "201907041741VEN1REV");
